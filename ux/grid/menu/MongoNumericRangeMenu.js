/**
 * @class Ext.ux.grid.menu.MongoNumericRangeMenu
 ...
 *          internally by {@link Ext.ux.grid.filter.MongoNumericFilter} to
 *          create its menu.
 */
Ext.define('Ext.ux.grid.menu.MongoNumericRangeMenu', {
	...
	getValue : function() {
		...
		for (key in this.fields) {
			...
			if (field.isValid()) {
				if (typeof(field.getValue()) === "number") {
	...
	onInputChange : function(field) {
		if (typeof field === "undefined" || field.getValue() === null) {
			return;
		}
		if (field.getValue() instanceof Array && field.getValue().length === 0) {
			return;
		...
		// incompatibilities
		// ______lte_lt__gte_gt__ne__eq__list
		// lte___-___1___0___0___0___1___1
		// lt____1___-___0___0___0___1___1
		// gte___0___0___-___1___0___1___1
		// gt____0___0___1___-___0___1___1
		// ne____0___0___0___0___-___1___1
		// eq____1___1___1___1___1___-___1
		// list__1___1___1___1___1___1___-
		...
		var incompatibilities = {
			...
			gt : ["gte", "eq", "list"],
			ne : ["eq", "list"],
			eq : ["lte", "lt", "gte", "gt", "ne", "list"],
			list : ["lte", "lt", "gte", "gt", "ne", "eq"]
		};
