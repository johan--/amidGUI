/**
 * @class Ext.ux.grid.filter.MongoNumericFilter
 ...
 *          configurations to MongoNumericFilter, and will be copied over to the
 *          internal menu instance automatically.
 *          </p>
 */
Ext.define('Ext.ux.grid.filter.MongoNumericFilter', {
	extend : 'Ext.ux.grid.filter.Filter',
	alias : 'gridfilter.mongoNumeric',
	...
	createMenu : function(config) {
		var me = this, menu;
		menu = Ext.create('Ext.ux.grid.menu.MongoNumericRangeMenu', config);
